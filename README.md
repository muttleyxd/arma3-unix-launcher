...
3) Install the arma3-unix-launcher with the new DayZ SA option ([here](https://github.com/muttleyxd/arma3-unix-launcher/blob/master/README.md#build-process-for-dayz)).
