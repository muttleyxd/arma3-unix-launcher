...
namespace ARMA3::Definitions
{
    ...
    static const std::array<char const *, 29> exclusions{"Addons", "AoW", "Argo", "BattlEye", "Contact", "Curator", "Dll", "Dta", "Enoch", "Expansion", "fontconfig", "GM", "CSLA", "Heli", "Jets", "Kart", "Keys", "Launcher", "MPMissions", "Mark", "Missions", "Orange", "SPE", "Tacops", "Tank", "vn", "WS", "legal", "steam_shader_cache"};
