function(create_test)
    ...
    add_executable(${GROUP}_${NAME} ${CREATE_TEST_SOURCES})
    target_include_directories(${GROUP}_${NAME} PRIVATE ${INCLUDES} ${CMAKE_SOURCE_DIR}/tests)
    target_link_libraries(${GROUP}_${NAME} PRIVATE ${LINK_LIBS} doctest::doctest trompeloeil::trompeloeil)
    add_test(${GROUP}_${NAME} ${GROUP}_${NAME})
endfunction()
